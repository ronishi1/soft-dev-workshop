...
def selectRandomStudent():
    # Selects a random team from the dictionary
    randomTeam = random.choice(list(KREWES))
    # Stores the list of names of the chosen team
    names = KREWES[randomTeam]
    # Prints a random name from the list of names
